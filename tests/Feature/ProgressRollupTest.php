...
class ProgressRollupTest extends TestCase
{
    ...
    public function test_progress_bubbles_from_subtask_to_project(): void
    {
        ...
        $milestone = Milestone::factory()->for($phase)->create();
        ...
        // one of two sub-tasks done => task/feature set/milestone/phase/project all 50
        ...
        $this->assertSame(50, $phase->fresh()->progress);
    ...
    public function test_project_with_no_phases_stays_zero(): void
    {
        $project = Project::factory()->create();
